...
import DraftEmail from "../services/DraftEmail";
const Dashboard = () => {
  ...
  const handleDraftClick = async () => {
    const mailboxId = "121YN4L4PRPGoRb";
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzgxMDI0Mzc1LCJpYXQiOjE3NTA3ODQzNzUsImp0aSI6ImY1MGQwYWMwYmQ1ZDQ4NGNiZjQyZTI5ZDE4MmM4YzhjIiwidXNlcl9pZCI6MTM3N30.eqbYY8JiTQ_2zh0JROdEU21dy47aySbYqv7tpGxsMFU"; // Replace with a real token
  ...
  return (
    <>
            ...
            <div className="flex flex-col justify-center items-start md:items-center pt-3 gap-2">
              ...
              {/* <div>
                ...
                <button
                  ...
                  className="w-[85%] h-[36px] mq1500:h-[45px]  flex justify-center items-center text-center whitespace-nowrap bg-[#305EFF] md:block rounded-md text-white text-[14px] mq1500:text-[18px] font-sans font-[600] leading-[20px]"
                >
                  New Message
                </button>
              </div> */}
              <div className="flex justify-center">
                <button
                  onClick={handleNewMessageClick}
                  className="w-[85%] h-[36px] mq1500:h-[45px] flex justify-center items-center bg-[#305EFF] rounded-md whitespace-nowrap px-[60px] py-[10px] text-white text-[14px] mq1500:text-[18px] font-sans font-[600] leading-[20px]"
                >
                  New Message
                </button>
              </div>
                ...
                <div className=" hover:bg-[#e4e7ea] cursor-pointer w-[72%] md:w-[85%] pl-2 pr-1 h-[32px] mq1500:h-[45px] mq1500:text-[18px] rounded-md flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <p
                      ...
                      className="text-[#40566D] text-[14px] mq1500:text-[18px] font-sans font-[600] leading-[20px]"
                    >
                      Drafts
                    </p>
                  </div>
            ...
            <div className="mx-4 flex flex-col gap-2 my-1">
              ...
              <div className="flex md:gap-3 gap-4 md:bg-[#F1F5FA] bg-[#F8FAFC] p-1 rounded-md cursor-pointer hover:bg-[#e4e7ea]">
                ...
                <span className="text-[#333333]">
                  ...
                  <p className="text-[8px] font-sans text-wrap">
                    Deliver mysterious, time-limited, or secretive messages with
                    a spooky flair.
                  </p>
                </span>
              </div>
              <div className="flex md:gap-[15px] gap-[18px] items-center md:bg-[#F1F5FA] bg-[#F8FAFC] p-1 rounded-md cursor-pointer hover:bg-[#e4e7ea]">
                ...
                <span className="text-[#333333]">
                  ...
                  <p className="text-[8px] font-sans text-wrap">
                    Effortlessly distribute messages to a large audience at
                    once.
                  </p>
                </span>
              </div>
      ...
      {showEmailSent && <SentEmail setshowEmailSent={setShowEmailSent} />}
    </>
  );
};
